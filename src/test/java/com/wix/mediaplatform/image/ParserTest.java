...
public class ParserTest {
    ...
    public void fromDto() throws Exception {
        Image image = Parser.fromDto("test.wix.com", new ImageDescriptor("parentFolderId", "hash", "fish.jpeg",
        ...
        assertThat(image.fit(100, 100).toUrl(), is("//test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg"));
    }

    @Test
    public void fromUrl() throws Exception {
        Image image = Parser.fromUrl("http://test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg");

        assertThat(image.fit(100, 100).toUrl(), is("http://test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg"));
    }

    @Test
    public void fromUrlWithPort() throws Exception {
        Image image = Parser.fromUrl("http://test.wix.com:8080/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg");

        assertThat(image.fit(100, 100).toUrl(), is("http://test.wix.com:8080/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg"));
    }

    @Test
    public void fromUrlEncodedFragment() throws Exception {
        Image image = Parser.fromUrl("http://test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image%2Fjpeg");
    ...
    public void fromUrlWithoutProtocol() throws Exception {
        Image image = Parser.fromUrl("//test.wix.com/user/bucket/imageId/v1/fit/w_100,h_100/fish.jpeg#w_10,h_10,mt_image/jpeg");
