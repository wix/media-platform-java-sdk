...
public class FileServiceTest extends BaseTest {
    ...
    private final FileService fileService = new FileService(configuration, authenticatedHttpClient, objectMapper,
            authenticator);
    ...
    public void uploadConfigurationRequest() throws Exception {
        ...
        UploadConfiguration response = fileService.uploadConfigurationRequest().execute();
